 ...
 * Copyright (c) 2009-2011 by Leeuwardenapp, Inc. All Rights Reserved.
...
//@interface LeeuwardenappObject : NSObject
//@end

@interface LeeuwardenappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LeeuwardenappObject class]])
		{
			for (NSString *key in [[(LeeuwardenappObject*)o modules] allKeys])
			{
