...
@interface LeeuwardenappObject : KrollCoverageObject {
#else
@interface LeeuwardenappObject : KrollObject {
#endif
@private
...
extern NSString * Leeuwardenapp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	LeeuwardenappObject *_leeuwardenapp;
	BOOL shutdown;
