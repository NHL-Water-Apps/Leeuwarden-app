...
// in simulator we redefine to format for Leeuwardenapp Developer console
...
{\
	NSString * exceptionName = [@"org.leeuwardenapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.leeuwardenapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILeeuwardenappNativeItemNone = -1, 
	UILeeuwardenappNativeItemSpinner = -2,
	UILeeuwardenappNativeItemProgressBar = -3,
	
	UILeeuwardenappNativeItemSlider = -4,
	UILeeuwardenappNativeItemSwitch = -5,
	UILeeuwardenappNativeItemMultiButton = -6,
	UILeeuwardenappNativeItemSegmented = -7,
	
	UILeeuwardenappNativeItemTextView = -8,
	UILeeuwardenappNativeItemTextField = -9,
	UILeeuwardenappNativeItemSearchBar = -10,
	
	UILeeuwardenappNativeItemPicker = -11,
	UILeeuwardenappNativeItemDatePicker = -12,
	
	UILeeuwardenappNativeItemInfoLight = -13,
	UILeeuwardenappNativeItemInfoDark = -14,
	
	UILeeuwardenappNativeItemDisclosure = -15,
	
	UILeeuwardenappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Leeuwardenapp instances of
