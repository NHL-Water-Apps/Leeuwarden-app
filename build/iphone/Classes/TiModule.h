...
/**
 The base class for all Leeuwardenapp modules
 */
...
/**
 Leeuwardenapp Platform calls this method on startup.
 */
-(void)startup;

/**
 Leeuwardenapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Leeuwardenapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Leeuwardenapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
