...
//Rare exceptions to indicate a bug in the _leeuwardenapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Leeuwardenapp proxies.
 */
